...
vac2=c(8138,62)
pcebo2=c(8138,62)
res2=as.table(cbind(vac2,pcebo2))
rownames(res2) <- c("none","aids")
```
...
```
With the people that got the placebo 10% more than the ones that recieved the vaccine were contaged with aids. This chart shows us that 10% of people got aids after the vaccine.
...
## Conclusions
with the data provided and the results that we got we can see that there is a difference of 20% of people that didnt have to worry about getting the aids virus because the vaccine was succesful. we see that 10% of people got aids from the trial. We can conclude that a good amout of people have benefit from getting the aids vaccine.
